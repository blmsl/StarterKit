...
export class SellComponent implements OnInit {
  ...
  stepperSelectionChange(selectedIndex) {
    this.stepperSelectedIndex = selectedIndex;
    if (selectedIndex == 2) {
      this.seenPreview = true;
    }
  }

  uploadsInProgress() {
    return this.uploads.filter(upload => upload.progress < 100 && upload.uploadTask);
  }
